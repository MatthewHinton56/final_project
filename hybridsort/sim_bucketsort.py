...
BUCKET_BANDWIDTH = 128 / thread_scale
BLOCK_N = SIZE / (THREAD_N * BUCKET_BANDWIDTH)
...
simulate_kernel('bucketsort', [DIVISIONS / THREAD_N, SIZE / (THREAD_N * BLOCK_N)], config_selection, THREAD_N, BLOCK_N, .5)
