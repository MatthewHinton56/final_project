...
blocks = SIZE / (THREAD_N * BUCKET_BANDWIDTH)
BLOCK_N = DIVISIONS / THREAD_N
iterations = blocks * DIVISIONS / DIVISIONS
...
simulate_kernel('bucketprefixoffset', [iterations], config_selection, THREAD_N, BLOCK_N, .5)
