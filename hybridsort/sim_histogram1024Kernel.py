...
THREAD_N = WARP_N * thread_scale * 32
BLOCK_N = 64 / thread_scale
...
simulate_kernel('histogram1024Kernel', [math.ceil(BLOCK_MEMORY / THREAD_N), math.ceil(SIZE / (THREAD_N * BLOCK_N)), math.ceil(BIN_COUNT / THREAD_N)], config_selection, THREAD_N, BLOCK_N, .5)
